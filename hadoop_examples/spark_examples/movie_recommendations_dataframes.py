...
def parse_ratings_line(line):
    ...
    return Row(user_id=user_id,	movie_id=int(movie_id),	rating=(int(rating))
...
if __name__ == "__main__":
	...
	high_rated_movies.select("movie_id").withColumn("user_id",lit(0))

	predictions	=	model.transform(high_rated_movies)	
	
	#Print the predictions to see how they look
	print "This is how predictions look like: "
	for prediction in predictions.take(10).collect():
		print prediction
